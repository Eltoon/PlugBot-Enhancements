...
function appendUser(user) {
    ...
    switch (vote) {
        case 1: // WOOT!
            colour = "3FFF00";
            if (bouncer)
                img = "https://dl.dropbox.com/u/53727046/plugbot/bouncerwoot.png";
            if (manager)
                img = "http://i.imgur.com/T5G4f.png";
            if (cohost || host)
                img = "http://i.imgur.com/Lu1qo.png";
            if (ambassador)
                img = "https://dl.dropbox.com/u/53727046/plugbot/ambassadorwoot.png";
            if (admin)
        ...
        case 0: // Undecided
            colour = "FFFFFF";
            if (bouncer)
                img = "https://dl.dropbox.com/u/53727046/plugbot/bouncerundecided.png";
            if (manager)
                img = "http://i.imgur.com/sRsU0.png";
            if (cohost || host)
                img = "http://i.imgur.com/6Bq5W.png";
            if (ambassador)
                img = "https://dl.dropbox.com/u/53727046/plugbot/ambassadorundecided.png";
            if (admin)
        ...
        case -1: // Meh
            colour = "ED1C24";
            if (bouncer)
                img = "https://dl.dropbox.com/u/53727046/plugbot/bouncermeh.png";
            if (manager)
                img = "http://i.imgur.com/JPA1Q.png";
            if (cohost || host)
                img = "http://i.imgur.com/wVLR3.png";
            if (ambassador)
                img = "https://dl.dropbox.com/u/53727046/plugbot/ambassadormeh.png";
            if (admin)
    ...
    $('#plugbot-userlist').append(
        ((bouncer || manager || cohost || host || ambassador || admin) ? '<img src="' + img + '" align="left" style="margin-left:6px" alt="Moderator" />' : '') +
        '<p style="' + ((bouncer || manager || cohost || host || ambassador || admin) ? 'text-indent:6px !important;' : '') +
